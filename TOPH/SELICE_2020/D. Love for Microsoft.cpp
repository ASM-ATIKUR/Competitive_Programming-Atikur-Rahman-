...
int main( int argc, char *argv[] )
{
    ...
    {
        if(s[i]=='m' && mp['m']==0) cnt++;
        else if(s[i]=='i' && mp['i']==0) cnt++;
        else if(s[i]=='c' && mp['c']==0) cnt++;
        else if(s[i]=='r' && mp['r']==0) cnt++;
        else if(s[i]=='o' && mp['o']==0) cnt++;
        else if(s[i]=='s' && mp['s']==0) cnt++;
        else if(s[i]=='f' && mp['f']==0) cnt++;
        else if(s[i]=='t' && mp['t']==0) cnt++;
        mp[s[i]]++;
    }
    if(cnt==8) printf("We both love Microsoft!\n");
    else printf("Only I love Microsoft!\n");
